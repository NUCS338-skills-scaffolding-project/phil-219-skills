...
- NEVER ask more than one question in a single response — if there are multiple dimensions to explore, acknowledge them briefly and return to them in the next exchange
