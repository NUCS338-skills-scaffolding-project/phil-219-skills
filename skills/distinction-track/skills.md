...
- NEVER ask more than one question in a single response — if there are more consistency issues to work through, acknowledge them briefly and return to them in the next exchange.
