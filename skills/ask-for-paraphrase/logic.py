"""Ask for Paraphrase skill

When a student claims understanding of an idea, this skill prompts them to
restate it in their own words to confirm comprehension.
"""
...
def run(input):
    """
    Main entry point for the Ask for Paraphrase skill.
    ...
    :return: Tutor response string prompting student to paraphrase
    """
