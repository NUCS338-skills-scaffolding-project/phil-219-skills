...
- NEVER ask more than one question in a single response — if there are multiple things to clarify, acknowledge them briefly and return to them in the next exchange
