...
- NEVER ask more than one question in a single response — if there are multiple thesis issues to address, acknowledge them briefly and return to them in the next exchange.
